...
export interface AftercareCategory {
  title: string;
  subtitle: string;
  icon: string;
  colors: [string, string];
  serviceKeywords: string[];
  topics: AftercareTopic[];
}

export const AFTERCARE_DATA: Record<string, AftercareCategory> = {
  coating: {
    ...
    topics: [
      {
        ...
        sections: [
          ...
          {
            heading: 'Free NanoFix 6-Month Periodic Maintenance',
            content: 'At MaskPro, we provide free NanoFix Super Hydrophobic Nano Coating maintenance (worth ₱9,500) once every six months while your warranty is in effect. This includes thorough inspection and recoating with NanoFix to restore the hydrophobic property of your coated surface — at no extra charge. However, a minimal detailing fee applies to cover complementary services such as vehicle washing, removing light scratches, removing hard stains/watermarks, and repairing minor coating damage. Detailing fees by vehicle size: Small ₱1,500 · Medium ₱2,000 · Large ₱2,500 · XLarge ₱3,000 · XXLarge ₱3,500; additional ₱2,500–₱5,000 may apply for severe damage based on assessment. Free maintenance coverage period depends on your package: Silver — up to 5 years, Gold — up to 7 years, Diamond — up to 12 years. Take your car to a MaskPro outlet before the hydrophobic property wears off!',
          },
        ],
      },
      {
    ...
    topics: [
      {
        ...
        sections: [
          ...
          { heading: 'When to Be Concerned', content: 'If bubbles persist after 30 days, or if the film shows purple discoloration, peeling edges, or delamination, contact your MaskPro installer. These issues are covered under your tint warranty. MaskPro Nano Ceramic Tint is warranted against fading, bubbling, peeling, and delamination under normal use conditions — refer to your installation certificate for coverage details.' },
        ],
      },
      {
        id: 'cleaning',
      ...
      },
      {
        ...
        sections: [
          { heading: 'Warranty Coverage', content: 'MaskPro Nano Ceramic Tint is warranted against bubbling, peeling, cracking, delamination, and color change/fading. Warranty duration depends on your product line: Hogo (Protection) — 12 years warranty, Shirudo (Shield) — 21 years warranty, Shirudo +Plus (Shield Plus) — Lifetime warranty, Mamori (Complete Defense) — Lifetime warranty. Keep your certificate of installation and receipt — these are your proof of warranty and will confirm your specific coverage.' },
    ...
    topics: [
      ...
      },
      {
        ...
        sections: [
          ...
          { heading: 'Drying Without Scratches', content: 'Use a premium drying towel (300+ GSM) or an air blower. Pat dry rather than drag-drying. Pay special attention to drying film edges where water can pool and seep underneath. A leaf blower on low setting is excellent for drying around PPF edges and complex curves.' },
      ...
      },
      {
        ...
        sections: [
          ...
          { heading: 'Maintaining Self-Healing Performance', content: 'Over time (3–5 years), the self-healing property diminishes as the top coat wears. Regular maintenance keeps it performing longer — avoid harsh chemicals, abrasive towels, and automatic car washes. Visit any MaskPro branch every 6 months for your free NanoFix maintenance recoating, which helps preserve the film\'s self-healing ability. The NanoFix recoating itself is free, but a minimal detailing fee applies for the preparatory work (washing, removing light scratches and stains): Small vehicles ₱1,500 | Medium ₱2,000 | Large ₱2,500 | XLarge ₱3,000 | XXLarge ₱3,500.' },
        ],
      },
      {
        id: 'yellowing',
        ...
        sections: [
          ...
          { heading: 'Maintaining Clarity', content: 'Keep the film clean, remove contaminants promptly, and avoid parking in extreme heat when possible. MaskPro applies a PPF-safe ceramic coating on top of the film for added UV protection and easier maintenance. This dual-layer approach — PPF + ceramic coating — provides the ultimate paint protection. To keep your film in top condition, visit any MaskPro branch every 6 months for your free NanoFix maintenance — the recoating is free, with only a minimal detailing fee for the preparatory work.' },
      ...
      },
      {
        ...
        sections: [
          ...
          { heading: 'Monthly: Deep Clean', content: 'Once a month, do a thorough wash to remove embedded contaminants. Use pH-neutral car shampoo and a soft microfiber wash mitt. Avoid using clay bars or chemical sprays on PPF unless recommended by your MaskPro technician. For deeper decontamination, bring your vehicle to any MaskPro branch — our team uses PPF-safe products and techniques to maintain the hydrophobic surface without risking damage to the film.' },
    ...
    topics: [
      ...
      },
      {
        ...
        sections: [
          ...
          { heading: 'Windshield Water Repellent', content: 'Apply a glass water repellent (like Rain-X or similar) to your windshield every 3 months. This creates a refractive barrier that makes rain bead up and roll off at highway speeds, dramatically improving visibility during heavy Philippine rainstorms. Apply after thorough glass cleaning for maximum bonding and longevity.' },
